        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Game1Id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameDeckCards", x => new { x.DeckId, x.Game1Id });
                    table.ForeignKey(
                        name: "FK_GameDeckCards_Cards_DeckId",
                        column: x => x.DeckId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameDeckCards_Games_Game1Id",
                        column: x => x.Game1Id,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    GameId = table.Column<int>(type: "integer", nullable: false),
                    TableCardsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameTableCards", x => new { x.GameId, x.TableCardsId });
                    table.ForeignKey(
                        name: "FK_GameTableCards_Cards_TableCardsId",
                        column: x => x.TableCardsId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameTableCards_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Cards",
                columns: new[] { "Id", "Colour", "Filling", "Number", "Shape" },
                values: new object[,]
                {
                    { 1, 0, 0, 1, 0 },
                    { 2, 0, 0, 2, 0 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameTableCards_TableCardsId",
                table: "GameTableCards",
                column: "TableCardsId");
        }
